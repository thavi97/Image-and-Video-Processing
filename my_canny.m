...
%   points.
    [grad_mag, grad_dir] = calculate_gradient(img);
    non_max = non_maxima_suppress(grad_mag, grad_dir);
    threshold_matrix(non_max, 1);
end
...
%elsewhere.
    ...
    %Implement this function
    img_matrix(mat<threshold) = 0;
    img_matrix(mat >= threshold) = 255;
    t_img = mat;
